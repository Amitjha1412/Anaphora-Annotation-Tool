...
public class AboutDialog {
	public static void showAboutDialog() {
		...
		JLabel titleLabel = new JLabel("AnaphoraAnnotation");
		titleLabel.setFont(new Font(Font.SERIF, Font.BOLD, 20));
		JLabel descLabel = new JLabel(
				"Anophora Annotaion Tool using Java Swing technlogies.");
		...
		creditsText
				.setText("This Tool would not have been possible without the generous tutorials, help"
